...
var parser = dashdash.createParser({
  options: [
    ...
    { names: ['proxy', 'p' ],
      type: 'string',
      default: null,
      help: 'HTTP proxy to use for outbound requests. Proxying requests to ' +
            'skim / fat is controlled with --proxy-skim / --proxy-fat / --proxy-tarballs',
      helpArg: 'URL' },
    { names: ['proxy-skim' ],
      type: 'bool',
      default: false,
      help: 'Use HTTP proxy for requests to fat' },
    { names: ['proxy-fat' ],
      type: 'bool',
      default: false,
      help: 'Use HTTP proxy for requests to skim' },
    { names: ['proxy-tarballs' ],
      type: 'bool',
      default: false,
      help: 'Use HTTP proxy for tarball requests' },
    { names: [ 'help', 'h' ],
      type: 'bool',
